...
(function() {
    ...
    $.bind('initReady', function() {
        $.discord.registerCommand('./discord/custom/goingLiveSystem-discord.js', 'goinglive', 1);
        ...
        $.discord.registerCommand('./discord/custom/goingLiveSystem-discord.js', 'autohost', 1);
        ...
        setTimeout(function() {
            setInterval(function() { doRunCheck(); }, 5e3, 'scripts::discord::custom::goingLiveSystem-discord.js');
        }, 5e3);
    });
